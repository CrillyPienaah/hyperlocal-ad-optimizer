...
export class MemStorage implements IStorage {
  ...
  private initializeDemoData() {
    ...
    const demoBusiness: Business = {
      ...
      city: "San Francisco",
      primaryNeighborhood: "SOMA",
      serviceAreas: "SOMA, Mission District, Castro, Nob Hill",
      serviceRadius: 5,
  ...
  async createBusiness(insertBusiness: InsertBusiness): Promise<Business> {
    ...
    const business: Business = {
      ...
      primaryNeighborhood: insertBusiness.primaryNeighborhood || null,
      serviceAreas: insertBusiness.serviceAreas || null,
